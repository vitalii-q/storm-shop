                ...
                <div class="col-md-12">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Создание категории</h3>
                        ...
                        <div class="block-content">
                            <form action="{{ route('admin.blog.articles.update', $article->id) }}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="mb-16">
                                            <input type="text" class="form-control" id="title" name="title" value="@isset($article->title){{ $article->title }}@endisset" placeholder="Заголовок..">
                                        </div>
                                        @error('title')
                                        ...
                                        <div class="mb-16">
                                            <input type="text" class="form-control" id="title_en" name="title_en" value="@isset($article->title_en){{ $article->title_en }}@endisset" placeholder="Title..">
                                        </div>
                                        @error('title_en')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                            ...
                                            <div class="col-md-12">
                                                <select class="form-control" id="category_id" name="category_id">
                                                    ...
                                                    @foreach($categories as $category)
                                                        <option value="{{ $category->id }}" @if($category->id == $article->category_id) selected @endisset>{{ $category->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-16">
                                            <textarea class="form-control" id="preview_text" name="preview_text" rows="6" placeholder="Описание..">@isset($article->preview_text){{ $article->preview_text }}@endisset</textarea>
                                        </div>
                                        @error('preview_text')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                        ...
                                        <div>
                                            <textarea class="form-control" id="preview_text_en" name="preview_text_en" rows="6" placeholder="Description..">@isset($article->preview_text_en){{ $article->preview_text_en }}@endisset</textarea>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="mb-16">
                                            <input type="code" class="form-control" id="code" name="code" placeholder="Code.." value="@isset($article->code){{ $article->code }}@endisset">
                                        </div>
                                        @error('code')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                        ...
                                        <div class="custom-file mb-43">
                                            ...
                                            <input onchange="adminShowImage(this)" type="file" class="custom-file-input js-custom-file-input-enabled" id="image_show_input" name="image" value="@isset($article->image){{ $article->image }}@endisset" data-toggle="custom-file-input" accept="image/*">
                                        ...
                                        <div class="col-md-12 animated fadeIn">
                                            <div class="options-container">
                                                <img id="imgShowElement" class="img-fluid options-item" src="@isset($article->image){{ URL::asset($article->image) }}@else {{ URL::asset('media/photos/photo1.jpg') }} @endisset" alt="">
                                ...
                                <div class="block">
                                    ...
                                    <textarea id="text" name="text">@isset($article->text){{ $article->text }}@endisset</textarea>
                                </div>
                                @error('text')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="block">
                                    ...
                                    <textarea id="text_en" name="text_en">@isset($article->text_en){{ $article->text_en }}@endisset</textarea>
                                </div>
                                @error('text_en')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
