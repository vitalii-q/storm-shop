        ...
        <div class="content">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    ...
                    <a href="{{ route('admin.blog.categories.create') }}" type="button" class="btn btn-sm btn-primary">Добавить</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('admin.blog.categories.edit', $category->id) }}" type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <form onclick="clickElem('submit{{$i}}')" action="{{ route('admin.blog.categories.destroy', $category->id) }}" method="post" class="btn btn-sm btn-secondary">
                                            @csrf
                                            @method('DELETE')
