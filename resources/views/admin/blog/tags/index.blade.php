    ...
    <main id="main-container">
        ...
        <div class="content">
            <nav class="breadcrumb bg-white push">
                ...
                <span class="breadcrumb-item active">Теги</span>
            </nav>
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    ...
                    <a href="{{ route('admin.blog.tags.create') }}" type="button" class="btn btn-sm btn-primary">Добавить</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('admin.blog.tags.edit', $tag->id) }}" type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <form onclick="clickElem('submit{{$i}}')" action="{{ route('admin.blog.tags.destroy', $tag->id) }}" method="post" class="btn btn-sm btn-secondary">
                                            @csrf
                                            @method('DELETE')
