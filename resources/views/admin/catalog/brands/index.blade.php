        ...
        <div class="content">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    ...
                    <a href="{{ route('admin.catalog.brands.create') }}" type="button" class="btn btn-sm btn-primary">Добавить</a>
                </div>
                <div class="block-content">
                    ...
                    <table class="table table-vcenter">
                        ...
                        @php($i = 1) @foreach($brands as $brand)
                            <tr>
                                <th class="text-center" scope="row">{{ $brand->id }}</th>
                                <td>{{ $brand->name }}</td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('admin.catalog.brands.edit', $brand->id) }}" type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <form onclick="clickElem('submit{{$i}}')" action="{{ route('admin.catalog.brands.destroy', $brand->id) }}" method="post" class="btn btn-sm btn-secondary">
                                            @csrf
                                            @method('DELETE')
