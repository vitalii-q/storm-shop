        ...
        <div class="content">
            <div class="row gutters-tiny invisible" data-toggle="appear">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block text-center" href="{{ route('admin.blog.articles.index') }}">
                        <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-dusk">
                            <div class="ribbon-box">{{ count($articles) }}</div>
                            <p class="mt-5">
                                <i class="si si-book-open fa-3x text-white-op"></i>
                            </p>
                            <p class="font-w600 text-white">Статьи</p>
                        </div>
                    </a>
                </div>

                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block text-center" href="{{ route('admin.blog.articles.create') }}">
                        <div class="block-content bg-gd-primary">
                            <p class="mt-5">
                                <i class="si si-plus fa-3x text-white-op"></i>
                            </p>
                            <p class="font-w600 text-white">Новая статья</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="block text-center">
                        <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                            <div class="ribbon-box">{{ count($comments) }}</div>
                            <p class="mt-5">
                                <i class="si si-bubbles fa-3x text-white-op"></i>
                            </p>
                            <p class="font-w600 text-white">Комментарии</p>
                        </div>
                    </div>
                </div>
            ...
            {{--<div class="row row-deck gutters-tiny invisible" data-toggle="appear">--}}
                {{--<!-- Row #2 -->--}}
                {{--<div class="col-xl-4">--}}
                    {{--<a class="block block-transparent bg-image d-flex align-items-stretch" href="javascript:void(0)" style="background-image: url({{ URL::asset('admin_panel/media/photos/photo34@2x.jpg') }});">--}}
            ...
            {{--<div class="row gutters-tiny invisible" data-toggle="appear">--}}
                ...
                {{--<div class="col-xl-8 d-flex align-items-stretch">--}}
                    {{--<div class="block block-themed block-mode-loading-inverse block-transparent bg-image w-100" style="background-image: url({{ URL::asset('admin_panel/media/photos/photo34@2x.jpg') }});">--}}
