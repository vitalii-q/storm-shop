...
<head>
    ...
    <link rel="shortcut icon" href="{{ URL::asset('admin_panel/media/favicons/favicon.png') }}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ URL::asset('admin_panel/media/favicons/favicon-192x192.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ URL::asset('admin_panel/media/favicons/apple-touch-icon-180x180.png') }}">
    <!-- END Icons -->

    <!-- Stylesheets -->
    <!-- Fonts and Codebase framework -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito+Sans:300,400,400i,600,700&display=swap">
    <link rel="stylesheet" id="css-main" href="{{ URL::asset('admin_panel/css/codebase.min.css') }}">
...
<div id="page-container" class="sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-fixed main-content-narrow">
            ...
            <div class="content-header-section align-parent">
                ...
                <div class="content-header-item">
                    <a class="img-link mr-5" href="be_pages_generic_profile.html">
                        <img class="img-avatar img-avatar32" src="{{ URL::asset('admin_panel/media/avatars/avatar15.jpg') }}" alt="">
                    </a>
                    ...
                    <ul class="nav-users push">
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="{{ URL::asset('admin_panel/media/avatars/avatar8.jpg') }}" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="{{ URL::asset('admin_panel/media/avatars/avatar16.jpg') }}" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="{{ URL::asset('admin_panel/media/avatars/avatar6.jpg') }}" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="{{ URL::asset('admin_panel/media/avatars/avatar15.jpg') }}" alt="">
                ...
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu min-width-300" aria-labelledby="page-header-options-dropdown">
                        ...
                        <div class="row no-gutters text-center mb-5">
                            ...
                            <div class="col-2 mb-5">
                                <a class="text-elegance" data-toggle="theme" data-theme="{{ URL::asset('admin_panel/css/themes/elegance.min.css') }}" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-pulse" data-toggle="theme" data-theme="{{ URL::asset('admin_panel/css/themes/pulse.min.css') }}" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-flat" data-toggle="theme" data-theme="{{ URL::asset('admin_panel/css/themes/flat.min.css') }}" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-corporate" data-toggle="theme" data-theme="{{ URL::asset('admin_panel/css/themes/corporate.min.css') }}" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-earth" data-toggle="theme" data-theme="{{ URL::asset('admin_panel/css/themes/earth.min.css') }}" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                        </div>
    ...
    -->
    <script src="{{ URL::asset('admin_panel/js/codebase.core.min.js') }}"></script>
    ...
    -->
    <script src="{{ URL::asset('admin_panel/js/codebase.app.min.js') }}"></script>

    <!-- Page JS Plugins -->
    <script src="{{ URL::asset('admin_panel/js/plugins/chartjs/Chart.bundle.min.js') }}"></script>

    <!-- Page JS Code -->
    <script src="{{ URL::asset('admin_panel/js/pages/be_pages_dashboard.min.js') }}"></script>
</body>
</html>