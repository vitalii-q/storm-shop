                        ...
                        <div class="sidebar-item category-list ul-li-block mb-30">
                            ...
                            <ul class="clearfix">
                                @foreach($categories as $category)
                                    <li><a href="{{ route('brand_category', [$selected_brand->code, $category->code]) }}">{{ $category->name }} <span class="float-right">({{ $category->getBrandCategorySkus($selected_brand->id)->count() }})</span></a></li>
                                @endforeach
                            </ul>
                        </div>
                        <!-- category-list - end -->
