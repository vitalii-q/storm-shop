...
@if(!empty($selected_category->name)) @php($title = $selected_brand->__('name').' '.mb_strtolower($selected_category->__('name'))) @else @php($title = $selected_brand->__('name')) @endif
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <h2 class="title-text"><strong>{{ $selected_brand->__('name') }} @if(!empty($selected_category->name)) {{ $selected_category->__('name') }} @endif</strong></h2>
                        </div>
            ...
            <div class="container">
                <ul class="clearfix">
                    ...
                    @if(empty(Route::current()->parameters['category']))
                        <li class="active">{{ $selected_brand->__('name') }}</li>
                    @else
                        <li><a href="{{ route('brand', $selected_brand->code) }}">{{ $selected_brand->__('name') }}</a></li>
        ...
        <div class="container">
            <div class="row justify-content-md-center">
                        ...
                        <div class="sidebar-item category-list ul-li-block mb-30">
                            ...
                            <ul class="clearfix">
                                @foreach($categories as $category)
                                    <li><a href="{{ route('brand_category', [$selected_brand->code, $category->code]) }}">{{ $category->__('name') }} <span class="float-right">({{ $category->getBrandCategorySkus($selected_brand->id)->count() }})</span></a></li>
                                @endforeach
                            </ul>
                        </div>
                        <!-- category-list - end -->
                ...
                <div class="col-lg-9 col-md-10 col-sm-12">
                    <div id="catalog-filter_content" @if(!empty($selected_category))data-position="brand-category" data-category-id="{{ $selected_category->id }}" @else data-position="brand" @endif data-brand-id="{{ $selected_brand->id }}" class="product-grid-section">
                        <div class="row">
